...
2.  The script will automatically install necessary components and create two folders:
    *   `Original`: Place your audio files here.
    *   `Converted`: Your MP3s will appear here.
3.  After the first run, put your music in the `Original` folder and run `run_converter.bat` again to convert them.
